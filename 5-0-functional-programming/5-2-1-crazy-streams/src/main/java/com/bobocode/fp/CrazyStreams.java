...
//        throw new ExerciseNotCompletedException();
    ...
    public List<Account> findAccountsByBirthdayMonth(Month birthdayMonth) {
        return accounts.stream()
                .filter(m -> m.getBirthday().getMonth().equals(birthdayMonth))
...
//        throw new ExerciseNotCompletedException();
    ...
    public int getNumOfLettersInFirstAndLastNames() {
        //throw new ExerciseNotCompletedException();
        return accounts.stream().mapToInt(a -> a.getFirstName().length()
                + a.getLastName().length()).sum();
...
//        throw new ExerciseNotCompletedException();
        return accounts.stream()
                .sorted(Comparator
                        .comparing(Account::getFirstName)
